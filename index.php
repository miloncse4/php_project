      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php if(isset($_SESSION['guest_mesg_done'])):?>
                        <small class="text-danger"><?=$_SESSION['guest_mesg_done']?></small>
                        <?php unset($_SESSION['guest_mesg_done']); ?>
                    <?php endif ?>
              <form id="contact" action="admin/guest_message_post.php" method="post">
                <div class="row">
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="guest_name" type="text" class="form-control" id="name" placeholder="Full Name">
                    </fieldset>
                    <?php if(isset($_SESSION['guest_name_err'])):?>
                        <small class="text-danger"><?=$_SESSION['guest_name_err']?></small>
                        <?php unset($_SESSION['guest_name_err']); ?>
                    <?php endif ?>
                  </div>
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="guest_email" type="text" class="form-control" id="email" pattern="[^ @]*@[^ @]*" placeholder="E-Mail Address">
                    </fieldset>
                    <?php if(isset($_SESSION['guest_email_err'])):?>
                        <small class="text-danger"><?=$_SESSION['guest_email_err']?></small>
                        <?php unset($_SESSION['guest_email_err']); ?>
                    <?php endif ?>
                  </div>
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="guest_subject" type="text" class="form-control" id="subject" placeholder="Subject">
                    </fieldset>
                    <?php if(isset($_SESSION['guest_subject_err'])):?>
                        <small class="text-danger"><?=$_SESSION['guest_subject_err']?></small>
                        <?php unset($_SESSION['guest_subject_err']); ?>
                    <?php endif ?>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <textarea name="guest_message" rows="6" class="form-control" id="message" placeholder="Your Message"></textarea>
                    </fieldset>
                    <?php if(isset($_SESSION['guest_message_err'])):?>
                        <small class="text-danger"><?=$_SESSION['guest_message_err']?></small>
                        <?php unset($_SESSION['guest_message_err']); ?>
                    <?php endif ?>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
